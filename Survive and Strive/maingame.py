...
pygame.display.set_caption("Survive and Strive")
...
bulletSound = pygame.mixer.Sound('Gun+Clip.wav')
...
man = player(player.x, player.y, 64, 64)
goblin = enemy (100, 380, 64, 64, 1150)
shootLoop = 0
bullets = []
run = True
while run:
